...
public class FiveBallAutonWithFender extends SequentialCommandGroup {
	public FiveBallAutonWithFender() {
		...
		final var trajectory5 = chassis.getGeneratedWPITrajectory(List.of(
				...
				new RigidTransform(new Translation(Units.inches2Meters(30), Units.inches2Meters(-70 - (13 * 12))), Rotation.degrees(-60))
		));
