...
import static com.gemsrobotics.lib.subsystems.drivetrain.Model.WheelState;
import static com.gemsrobotics.lib.subsystems.drivetrain.Model.ChassisState;
...
public class TestPhysics {
    ...
    public void testMotorTransmission() {
        final double kEpsilon = MathUtils.kEpsilon;
        ...
        assertThat(Units.rpm2RadsPerSecond(1200.0), closeTo(motor.freeSpeedAtVoltage(12.0 + 1.5), kEpsilon));
        assertThat(Units.rpm2RadsPerSecond(600.0), closeTo(motor.freeSpeedAtVoltage(6.0 + 1.5), kEpsilon));
        assertThat(Units.rpm2RadsPerSecond(0.0), closeTo(motor.freeSpeedAtVoltage(1.4), kEpsilon));
        assertThat(Units.rpm2RadsPerSecond(0.0), closeTo(motor.freeSpeedAtVoltage(0.0), kEpsilon));
        assertThat(Units.rpm2RadsPerSecond(0.0), closeTo(motor.freeSpeedAtVoltage(-1.4), kEpsilon));
        assertThat(Units.rpm2RadsPerSecond(-600.0), closeTo(motor.freeSpeedAtVoltage(-6.0 - 1.5), kEpsilon));
        assertThat(Units.rpm2RadsPerSecond(-1200.0), closeTo(motor.freeSpeedAtVoltage(-12.0 - 1.5), kEpsilon));
    ...
    public void testModel() {
        ...
        Model drive = new Model(props, transmission);
//        // Kinematics
        ChassisState v1 = drive.forwardKinematics(new Model.WheelState(0.0, 0.0));
        ...
        ChassisState v2 = drive.forwardKinematics(new Model.WheelState(Units.rpm2RadsPerSecond(65.0 * 10.0), Units.rpm2RadsPerSecond(65.0 * 10.0)));
        ...
        ChassisState v3 = drive.forwardKinematics(new Model.WheelState(Units.rpm2RadsPerSecond(65.0 * -10.0), Units.rpm2RadsPerSecond(65.0 * -10.0)));
        ...
        ChassisState v4 = drive.forwardKinematics(new Model.WheelState(Units.rpm2RadsPerSecond(-65.0 * 10.0), Units.rpm2RadsPerSecond(65.0 * 10.0)));
        ...
        ChassisState v5 = drive.forwardKinematics(new Model.WheelState(Units.rpm2RadsPerSecond(65.0 * 5.0), Units.rpm2RadsPerSecond(-65.0 * 5.0)));
        ...
        // Forward dynamics.
        Model.Dynamics d1 = drive.solveForwardDynamics(new Model.ChassisState(0.0, 0.0), new Model.WheelState(0.0, 0.0), false);
        assertThat(0.0, closeTo(d1.torque.left, kEpsilon));
        assertThat(0.0, closeTo(d1.torque.right, kEpsilon));
        assertThat(0.0, closeTo(d1.wheelAcceleration.left, kEpsilon));
        assertThat(0.0, closeTo(d1.wheelAcceleration.right, kEpsilon));
        ...
        Model.Dynamics d2 = drive.solveForwardDynamics(new Model.ChassisState(0.0, 0.0), new Model.WheelState(12.0, 12.0), false);
        assertThat(11.0 * .35, closeTo(d2.torque.left, kEpsilon));
        assertThat(11.0 * .35, closeTo(d2.torque.right, kEpsilon));
        assertThat(0.0, lessThan(d2.wheelAcceleration.left));
        assertThat(0.0, lessThan(d2.wheelAcceleration.right));
        assertThat(2.0, lessThan(d2.chassisAcceleration.linear));
        assertThat(0.0, closeTo(d2.chassisAcceleration.angular, kEpsilon));

        Model.Dynamics d3 = drive.solveForwardDynamics(new Model.ChassisState(0.0, 0.0), new Model.WheelState(-12.0, -12.0), false);
        assertThat(-11.0 * .35, closeTo(d3.torque.left, kEpsilon));
        assertThat(-11.0 * .35, closeTo(d3.torque.right, kEpsilon));
        assertThat(0.0, greaterThan(d3.wheelAcceleration.left));
        assertThat(0.0, greaterThan(d3.wheelAcceleration.right));
        assertThat(0.0, greaterThan(d3.chassisAcceleration.linear));
        assertThat(0.0, closeTo(d3.chassisAcceleration.angular, kEpsilon));

        Model.Dynamics d4 = drive.solveForwardDynamics(new Model.ChassisState(0.0, 0.0), new Model.WheelState(-12.0, 12.0), false);
        assertThat(-11.0 * .35, closeTo(d4.torque.left, kEpsilon));
        assertThat(11.0 * .35, closeTo(d4.torque.right, kEpsilon));
        assertThat(0.0, greaterThan(d4.wheelAcceleration.left));
        assertThat(0.0, lessThan(d4.wheelAcceleration.right));
        assertThat(0.0, closeTo(d4.chassisAcceleration.linear, kEpsilon));
        assertThat(0.0, lessThan(d4.chassisAcceleration.angular));

        // Inverse dynamics.
        Model.Dynamics d5 = drive.solveInverseDynamics(new Model.ChassisState(0.0, 0.0), new Model.ChassisState(0.0, 0.0), false);
        ...
        Model.Dynamics d6 = drive.solveInverseDynamics(new Model.ChassisState(Units.feet2Meters(10.0), 0.0), new Model.ChassisState(0.0, 0.0), false);
        ...
        Model.Dynamics d7 = drive.solveInverseDynamics(new Model.ChassisState(Units.inches2Meters(10.0 * 12), 0.0), new Model.ChassisState(Units.inches2Meters(2.0 * 12.0), 0.0), false);
        ...
        Model.Dynamics d8 = drive.solveInverseDynamics(new Model.ChassisState(Units.inches2Meters(10.0 * 12), 0.0), new Model.ChassisState(Units.inches2Meters(-2.0 * 12), 0.0), false);
...
//        assertThat(14.0, closeTo(d9.voltage.right, kEpsilon));
        ...
        assertThat(Units.feet2Meters(3.0), closeTo(drive.calculateMaxVelocity(1.0 / drive.wheelBaseRadius, 6.0, false), kEpsilon));
        assertThat(Units.feet2Meters(3.0), closeTo(drive.calculateMaxVelocity(-1.0 / drive.wheelBaseRadius, 6.0, false), kEpsilon));
        ...
        // Max acceleration.
        Bounds accelerations1 = drive.calculateMinMaxAcceleration(new Model.ChassisState(0.0, 0.0), 0.0, 12.0, false);
        assertThat(2.0, closeTo(accelerations1.max, kEpsilon));
        assertThat(-2.0, closeTo(accelerations1.min, kEpsilon));

        Bounds accelerations2 = drive.calculateMinMaxAcceleration(new Model.ChassisState(0.0, 0.0), 0.0, 6.0, false);
        assertThat(1.0, closeTo(accelerations2.max, kEpsilon));
        assertThat(-1.0, closeTo(accelerations2.min, kEpsilon));

        Bounds accelerations3 = drive.calculateMinMaxAcceleration(new Model.ChassisState(Units.feet2Meters(8.0), 0.0), 0.0, 12.0, false);
        assertThat(1.0, closeTo(accelerations3.max, kEpsilon));
        assertThat(-4.0, closeTo(accelerations3.min, kEpsilon));

        Bounds accelerations4 = drive.calculateMinMaxAcceleration(new Model.ChassisState(0.0, 0.0), Double.POSITIVE_INFINITY, 6.0, false);
