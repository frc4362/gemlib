...
//        // Kinematics
        ...
        // Forward dynamics.
        Model.Dynamics d1 = drive.solveForwardDynamics(new ChassisState(0.0, 0.0), new WheelState(0.0, 0.0), false);
        ...
        Model.Dynamics d2 = drive.solveForwardDynamics(new ChassisState(0.0, 0.0), new WheelState(12.0, 12.0), false);
        ...
        Model.Dynamics d3 = drive.solveForwardDynamics(new ChassisState(0.0, 0.0), new WheelState(-12.0, -12.0), false);
        ...
        Model.Dynamics d4 = drive.solveForwardDynamics(new ChassisState(0.0, 0.0), new WheelState(-12.0, 12.0), false);
        ...
        // Inverse dynamics.
        Model.Dynamics d5 = drive.solveInverseDynamics(new ChassisState(0.0, 0.0), new ChassisState(0.0, 0.0), false);
        ...
        Model.Dynamics d6 = drive.solveInverseDynamics(new ChassisState(Units.feet2Meters(10.0), 0.0), new ChassisState(0.0, 0.0), false);
        ...
        Model.Dynamics d7 = drive.solveInverseDynamics(new ChassisState(Units.inches2Meters(10.0 * 12), 0.0), new ChassisState(Units.inches2Meters(2.0 * 12.0), 0.0), false);
        ...
        Model.Dynamics d8 = drive.solveInverseDynamics(new ChassisState(Units.inches2Meters(10.0 * 12), 0.0), new ChassisState(Units.inches2Meters(-2.0 * 12), 0.0), false);
